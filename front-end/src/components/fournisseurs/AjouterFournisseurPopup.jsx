function AjouterFournisseurPopup({ form, setForm, error, villes, fermerModal, enregistrerFourn }) {
  return (
    <div className="modal-overlay open">
      <div className="modal">
        <div className="modal-header">
          <div className="modal-title"><i className="fas fa-industry"></i> Nouveau fournisseur</div>
...
export default AjouterFournisseurPopup
